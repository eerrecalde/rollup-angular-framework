...
directiveData.directive('ctpPaginator', function () {
  ...
  paginator.link = function (scope, element, attrs) {
    ...
    scope.$watchCollection(attrs.items, function (newValue) {
      fillUpDataObject(newValue, 'items');
    });

    scope.$watchCollection(attrs.currentPage, function (newValue) {
      if (newValue !== undefined) {
        fillUpDataObject(newValue === null ? 0 : newValue, 'currentPage');
      }
    });

    scope.$watchCollection(attrs.itemsPerPage, function (newValue) {
      if (newValue !== undefined) {
...
var FilterIoCore = function filterIo() {
  /**
...
directiveData.directive('ctpFilterIo', function () {
  ...
  ctpFilterIo.link = function (scope, element, attrs) {
    ...
    scope.$watchCollection(attrs.filters, function (newValue) {
      fillUpScopePrefix(newValue, 'filterArray');
    });

    scope.$watchCollection(attrs.isPartial, function (newValue) {
